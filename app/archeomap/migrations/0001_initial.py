# Generated by Django 5.0.4 on 2024-04-16 05:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('custom_category_value', models.CharField(choices=[('NONE', 'NONE'), ('Памятники с обозначением на местности', 'Памятники с обозначением на местности'), ('Самые выдающиеся памятники: выбор редакции', 'Самые выдающиеся памятники: выбор редакции'), ('Памятники, напрямую связанные с историческими личностями', 'Памятники, напрямую связанные с историческими личностями'), ('Первые археологические раскопки в Петербурге', 'Первые археологические раскопки в Петербурге')], max_length=255, verbose_name='Кастомная категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(to='archeomap.testcategory', verbose_name='категория')),
            ],
        ),
    ]
